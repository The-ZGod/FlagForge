  ...
  return (
    <div
      className={cn(
        ...
        globalColor === "monochrome" ? "bg-[#000000]" : "bg-[#08080a]",
        className,
      )}
    >
      <canvas
      ...
      {/* Smooth bottom fade-out to blend seamlessly into the rest of the page */}
      <div
        aria-hidden="true"
        className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-background via-background/60 to-transparent z-1 pointer-events-none"
      />
